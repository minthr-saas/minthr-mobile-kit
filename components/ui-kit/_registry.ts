...
export const kitComponents: readonly KitComponentEntry[] = [
  ...
  },
  {
    ...
    category: 'Navigation',
    status: 'ready',
    description: 'Screen-top template — title + optional subtitle + back button + actions slot.',
  },
  {
    name: 'Accordion',
    path: '/accordion',
  ...
  },
  {
    ...
    category: 'Display',
    status: 'ready',
    description: 'Single-stat card — label, big number, optional trend pill, optional hint.',
  },
  {
    name: 'Breadcrumbs',
    path: '/breadcrumbs',
  ...
  },
  {
    ...
    category: 'Overlays',
    status: 'ready',
    description: 'Bottom-anchored action menu — the mobile-idiomatic replacement for desktop dropdown menus.',
  },
  {
    name: 'ProfileHeader',
    path: '/profile-header',
    category: 'Navigation',
    status: 'ready',
    description: 'Entity-profile hero strip — avatar, name, status, quick actions, and tabs slot.',
  },
  {
    name: 'SelectionBar',
    path: '/selection-bar',
  ...
  },
  {
    ...
    category: 'Navigation',
    status: 'ready',
    description: 'Custom pagination component adapted for mobile layouts.',
  },
  {
    name: 'FAB',
    path: '/fab',
  ...
  },
  {
    ...
    category: 'Navigation',
    status: 'ready',
    description: 'Top screen chrome — title, optional subtitle, back button, and a slot for trailing icon actions. Start-aligned or centered.',
  },
];
